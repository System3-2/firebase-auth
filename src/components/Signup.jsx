...
const Signup = () => {
  ...
  return (
    <>
      <h2 className='text-center text-lg font-bold mt-8 text-slate-700'>Signup</h2>
      <section className='p-4 m-4 flex items-center justify-center gap-2 shadow-lg md:shadow-none shadow-slate-600 flex-col'>
        ...
        <form onSubmit={handleSubmit}
          ...
          <button className='py-2 font-bold  bg-slate-400 mt-4 flex items-center justify-center rounded-lg' type='submit'>Signup</button>
        ...
        <Link to={'/login'} className='text-sm mt-4  font-extrabold p-2 text-slate-500 '>Already have an account? Login</Link>
